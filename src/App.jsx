...
export default function App() {//parent
  ...
  return (
    <div className="container">
      ...
      <Button variant="primary" onClick={mode==='add' ? addItem : updateItem}>{mode==='add'? 'Add' :'Update'} items</Button>

        </div>
        <div className="col-md-6">
          <h1>List items</h1>
          {/* child component  */}
          <Product  list={items} handleDelete={handleParentDelete}  handleEdit={handleParentEdit} /> 
        </div>
      </div>
    </div>
  );
